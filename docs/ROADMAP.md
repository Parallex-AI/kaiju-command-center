...
- [ ] **V5.12.6** — `SecretStoreFactory` — selects `InMemorySecretStore` vs `GCPSecretManagerStore` based on `GCP_SECRET_MANAGER_ENABLED` · wired into `compose_google_ads_credentials`
